...
public class CreditCardBean {
	...
	public CreditCardBean(BigInteger accountNumber , BigInteger creditCardNumber, boolean creditCardStatus, String nameOnCreditCard, int CreditCvvNum, int creditCurrentPin,
	...
	public void setCreditScore(int ceditScore) {
